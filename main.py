...
print(f"🚀 BOT VALUE BETTING FINAL DÉMARRÉ - {datetime.now().strftime('%H:%M')}")
...
def api_football(endpoint, params=None):
    ...
    r = requests.get(f"https://v3.football.api-sports.io{endpoint}", headers={"x-apisports-key": API_FOOTBALL_KEY}, params=params)
